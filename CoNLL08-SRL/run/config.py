...
class Configurable(object):
	...
	@property
	def unlabeled_dev_file(self):
		return self._config.get('Data','bootstrap_dev_file')
	@property
	def labeled_dev_file(self):
		return self._config.get('Data','gold_dev_file')
	@property
	def raw_dev_file(self):
		return self._config.get('Data','raw_dev_file')
	@property
	def unlabeled_test_file(self):
		return self._config.get('Data','bootstrap_test_file')
	@property
	def labeled_test_file(self):
		return self._config.get('Data','gold_dev_file')
	@property
